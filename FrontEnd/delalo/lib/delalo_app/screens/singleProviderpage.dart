        ...
        child: BlocListener<ProviderProfileBloc, ProviderProfileState>(
          listener: (context, state) async{
            if (state is ProviderProfileInitial) {
              ...
              final provId = await SESSION.getString('providerForSingleProviderPage');
              final seekId = await SESSION.getString('id');
              BlocProvider.of<ProviderProfileBloc>(context).add(LoadProviderInfo(providerId: provId.toString(), seekerId: seekId.toString()));
              BlocProvider.of<ReviewsOfProviderBloc>(context).add(LoadReviewsOfProvider(providerId: provId.toString()));
            }
          },
          child: Container(
            color: Colors.white,
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Column(
                                        children: [
                                          Text(
                                            state.orderDetailsOfProvider[i].user
                                                    .firstname +
                                                "  " +
